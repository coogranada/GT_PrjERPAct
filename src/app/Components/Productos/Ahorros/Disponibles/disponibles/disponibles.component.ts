...
export class DisponiblesComponent implements OnInit {
    ...
    if (result !== null) {
      ...
      if (result.length >= 1) {
        ...
        if (this.DisponibleForm.get('IdMedioPago')?.value === 0) {
          if (this.dataObjet[0].IdCuentaCupo !== 0) {
            if (this.dataObjet[0].Cupo !== null) {
              ...
              this.DisponibleForm.get('TipoPagare')?.setValue(this.dataObjet[0].Cupo.TipoPagare);
        ...
        if (this.DisponibleForm.get('IdMedioPago')?.value === 10 || this.DisponibleForm.get('IdMedioPago')?.value === 50 || this.DisponibleForm.get('IdMedioPago')?.value === 60 || this.DisponibleForm.get('IdMedioPago')?.value === 70) {
          ...
          this.DisponibleForm.get('TipoPagare')?.setValue(this.dataObjet[0].Tarjetas.TipoPagare);
          ...
          this.DisponibleForm.get('TipoPagare')?.setValue("0"); 
        }
        // Fin tarjeta
        ...
        if (this.DisponibleForm.get('IdMedioPago')?.value === 0) {
          if (this.dataObjet.IdCuentaCupo !== 0) {
            if (this.dataObjet.Cupo !== null) {
              ...
              this.DisponibleForm.get('TipoPagare')?.setValue(this.dataObjet.Cupo.TipoPagare); 
        ...
        if (this.DisponibleForm.get('IdMedioPago')?.value === 10 || this.DisponibleForm.get('IdMedioPago')?.value === 50 || this.DisponibleForm.get('IdMedioPago')?.value === 60 || this.DisponibleForm.get('IdMedioPago')?.value === 70) {
          ...
          this.DisponibleForm.get('TipoPagare')?.setValue(this.dataObjet.Tarjetas.TipoPagare);
            ...
            result => {
              ...
              if (result.length === 0) {               
                      ...
                      this.DisponibleForm.controls['NumeroPagare'].setValue("");
                       this.DisponibleForm.controls['TipoPagare'].setValue("0");
  ...
  ValidacionMediopagoInputs() {
    if (this.DisponibleOperacionFrom.get('Codigo')?.value == 10 || this.DisponibleOperacionFrom.get('Codigo')?.value == 40 || this.DisponibleOperacionFrom.get('Codigo')?.value == 38) {
      ...
      if ((this.DisponibleForm.get('IdMedioPago')?.value == 10 && this.DisponibleForm.get('IdConvenio')?.value != 0 && this.DisponibleForm.get('NumeroTarjeta')?.value != "") ||
        (this.DisponibleForm.get('IdMedioPago')?.value == 50 && this.DisponibleForm.get('IdConvenio')?.value != 0 && this.DisponibleForm.get('NumeroTarjeta')?.value != "" && this.DisponibleForm.get('NumeroPagare')?.value != ""  && this.DisponibleForm.get('TipoPagare')?.value != "0" && this.DisponibleForm.get('IdDiaCorte')?.value != "0" && this.DisponibleForm.get('IdPlazo')?.value != "0") ||
        (this.DisponibleForm.get('IdMedioPago')?.value == 60 && this.DisponibleForm.get('IdConvenio')?.value != 0) ||
        (this.DisponibleForm.get('IdMedioPago')?.value == 70 && this.DisponibleForm.get('IdConvenio')?.value != 0 && this.DisponibleForm.get('NumeroPagare')?.value != ""  && this.DisponibleForm.get('TipoPagare')?.value != "0" && this.DisponibleForm.get('IdDiaCorte')?.value != "0" && this.DisponibleForm.get('IdPlazo')?.value != "0")) {
  ...
  GuardarDisponible() {
    ...
    let numeroPagare = this.DisponibleForm.get('NumeroPagare')?.value;
    let  tipoPagare = this.DisponibleForm.get('TipoPagare')?.value;
    const plazo = this.DisponibleForm.get('IdPlazo')?.value;
    const diaCorte = this.DisponibleForm.get('IdDiaCorte')?.value;

    if (tipoPagare === '0') { tipoPagare = null;}
    if (numeroPagare === '0') { numeroPagare = '';}
    if ((numeroPagare && numeroPagare.trim() !== "" && !tipoPagare) || (tipoPagare && (!numeroPagare || numeroPagare.trim() === ""))) 
      {
        this.notif.warning('Advertencia', 'Debe ingresar número y tipo de pagaré.', ConfiguracionNotificacion.configRightTop);  
        return;
      }
    ...
    } else if((mediopago === '50') && (!numeroPagare || numeroPagare.trim()==='' || !tipoPagare || tipoPagare.trim()==='' || !plazo || plazo.trim()==='' || !diaCorte || diaCorte.trim()==='' )) {
    ...
    } else if((mediopago === '70') && (!numeroPagare || numeroPagare.trim()==='' || !tipoPagare || tipoPagare.trim()==='' || !plazo || plazo.trim()==='' || !diaCorte || diaCorte.trim()==='' )) {
      this.notif.warning('Advertencia', 'Debe ingresar los campos obligatorios para el medio de pago seleccionado.', ConfiguracionNotificacion.configRightTop);
    }else{
    this.isSaving = true;
    this.BloquearConvenio = false;
    ...
    if (this.DisponibleForm.get('IdMedioPago')?.value == '0') {
      ...
      const tipoPagare = this.DisponibleForm.get('TipoPagare')?.value;
      
      if (numeroPagare && numeroPagare !== "" && tipoPagare) {
          aperturaCuentaLog.NumeroPagare = numeroPagare;
          if (tipoPagare === '1') {
            aperturaCuentaLog.TipoPagare = 'Desmaterializado';
          } else if (tipoPagare === '2') {
            aperturaCuentaLog.TipoPagare = 'Físico';
          } else {
            aperturaCuentaLog.TipoPagare = 'Sin tipo de pagare';
          }
      } else {
        aperturaCuentaLog.NumeroPagare = 'Sin Pagare';
        aperturaCuentaLog.TipoPagare = 'Sin Pagare';
      }
    }
  ...
  ActualizarDisponible() {
    ...
    if (this.DisponibleForm.get('IdOficina')?.value !== null
      ...
      if (this.DisponibleOperacionFrom.get('Codigo')?.value === '12') {         // Actualizar titulares disponibles
        ...
        const tipoPagare: string = `${this.DisponibleForm.get('TipoPagare')?.value ?? ''}`;
        ...
        let MedioPagoLog: any = {
          Anterior: this.resultMedioPago.filter(( x: any) => x.IdMedioPago == this.datoMedioPago)[0].Descripcion,
          Actualiza: this.resultMedioPago.filter(( x: any) => x.IdMedioPago == this.DisponibleForm.get('IdMedioPago')?.value)[0].Descripcion,
        ...
        if (this.DisponibleForm.get('NumeroPagare')?.value != ""){
          if(this.DisponibleForm.get('TipoPagare')?.value == 1){
             MedioPagoLog.TipoPagare = 'Desmaterializado';
          } else if (this.DisponibleForm.get('TipoPagare')?.value == 2){
            MedioPagoLog.TipoPagare = 'Físico';
          }
        ...
        if (this.DisponibleForm.get('IdMedioPago')?.value === '10' || this.DisponibleForm.get('IdMedioPago')?.value === '60') {
          ...
          if (numeroPagare === '0') { numeroPagare = '';}
            if ((numeroPagare && numeroPagare.trim() !== "" && !tipoPagare) || (tipoPagare && (!numeroPagare || numeroPagare.trim() === ""))) 
            {
             this.notif.warning('Advertencia', 'Debe ingresar número y tipo de pagaré juntos.', ConfiguracionNotificacion.configRightTop);  
              return;
            }
...
// FIN TAB HISTORIAL
  ...
  validateForm() {
    ...
    const TipoPagare = new FormControl('', []);
