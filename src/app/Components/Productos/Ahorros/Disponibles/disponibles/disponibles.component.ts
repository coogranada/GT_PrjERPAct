    ...
    if (this.DisponibleForm.get('IdOficina')?.value !== null
      ...
      if (this.DisponibleOperacionFrom.get('Codigo')?.value === '12') {         // Actualizar titulares disponibles
          ...
          result => {
            ...
            if (this.dataObjetC.Canales.length > 0) {
              ...
              if ((tempPosOld != tempPos && tempPosOld != null && tempPos != null) || (tempPosOld == null && tempPos != null))
                canalesLog.push(tempPosOld == null ? { Accion: "Adicion", Canal: tempPos.Canal, Descripcion: tempPos.Descripcion, nroOperaciones: tempPos.NumeroOperaciones, Cupo: tempPos.MontoMaximo } : { Accion: "Editar", CanalAnterior: tempPosOld.Canal, DescripcionAnterior: tempPosOld.Descripcion, nroOperacionesAnterior: tempPosOld.NumeroOperaciones, CupoAnterior: tempPosOld.MontoMaximo, CanalActualizar: tempPos.Canal, DescripcionActualiza: tempPos.Descripcion, NroOperacionesAtualiza: tempPos.NumeroOperaciones, CupoActualiza: tempPos.MontoMaximo });
              ...
              if ((tempWebOld != tempWeb && tempWebOld != null && tempWeb != null) || (tempWebOld == null && tempWeb != null))
                canalesLog.push(tempWebOld == null ? { Accion: "Adicion", Canal: tempWeb.Canal, Descripcion: tempWeb.Descripcion, nroOperaciones: tempWeb.NumeroOperaciones, Cupo: tempWeb.MontoMaximo } : { Accion: "Editar", CanalAnterior: tempWebOld.Canal, DescripcionAnterior: tempWebOld.Descripcion, nroOperacionesAnterior: tempWebOld.NumeroOperaciones, CupoAnterior: tempWebOld.MontoMaximo, CanalActualizar: tempWeb.Canal, DescripcionActualiza: tempWeb.Descripcion, NroOperacionesAtualiza: tempWeb.NumeroOperaciones, CupoActualiza: tempWeb.MontoMaximo });
        ...
        this.DisponiblesServices.TimbrarMensaje(payload).subscribe(( x: any) => {
          this.loading = false;
          this.notif.success('Exitoso', 'Se timbra mensaje correctamente.', ConfiguracionNotificacion.configRightTop);
