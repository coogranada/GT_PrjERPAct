...
import { Tabs, TipoBusquedaResumen, TipoSistemas } from '../../../../Models/Productos/cartera/gestion-credito.enum';
...
//DATOS 
  ...
  onCuotaTabClick() {
    this.onTabChange(Tabs.ValorCuota, () => this.BuscarSaldosCartera());
  }
