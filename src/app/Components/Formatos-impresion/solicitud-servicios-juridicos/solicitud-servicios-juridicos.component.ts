...
export class SolicitudServiciosJuridicosComponent implements OnInit {
  ...
  CargarServicio(dataService : any) {    
    ...
    this.servicioSolicitado.OrigenFondos = dataService.OrigenFondos;
  }
  ...
  CargarSecciones(dataPrint : any) {
    ...
    if(dataPrint.BasicosDto.FechaConstitucion) {
    ...
    Swal.fire({
      ...
      if(result.value) {
        ...
        const formInsertData = {
          ...
          OrigenFondos: this.GetServiceSolicited.OrigenFondos
