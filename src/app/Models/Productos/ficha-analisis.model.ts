export class FADeudor{
  ...
  MaxOpCancelRealData : string = "";
  MaxOpCancelFinanData : string = "";
  MaxOpCancelFinanCoograData : string = "";
  IngresoMinimoData: string = "";
  IngresoMedioData: string = "";
  IngresoMaximoData: string = "";
  ValorIngresoData: string = "";
  SalarioTotalData: string = "";
  PromedioIngresoData: string = "";
  TipoFicha: number | null = null;
  TipoOcupa: number | null = null;
  ...
  ObsFirmantes : number | string = "";
  ObsPromcuentas : number | string = "";
  SaldosVigentesRecoge : number | string = "";
  saldoAhoDispo : string = "";
  saldoAhoCon : string = "";
  saldoAhoTer : string = "";
  ...
  VigentesPrinData : string | null = "";
  VigentesCodeData : string | null = "";
  ExtinguidasPrinData : string | null = "";
  ExtinguidasCodeData : string | null = "";
  EmpleadorData: string | null = "";
  CheckList : any = false;
